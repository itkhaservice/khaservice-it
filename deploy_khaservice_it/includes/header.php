<?php
// Tự động xác định thư mục gốc để tải Assets chính xác
$current_dir = dirname($_SERVER['PHP_SELF']);
$base_path = (strpos($current_dir, 'public') !== false) ? '../' : '';
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <script src="<?php echo $base_path; ?>assets/js/audio_feedback.js" defer></script>
    <style>
...
<body>
    <header class="main-header">
        <div class="header-left">
            ...
            <div class="logo">
                <a href="index.php">KHASERVICE IT</a>
            </div>
        </div>
