...
$health_labels = ['good' => '<span class="status-badge status-success">Tốt</span>', 'warning' => '<span class="status-badge status-warning">Cảnh báo</span>', 'broken' => '<span class="status-badge status-danger">Hỏng</span>'];
